...
# ╔═╡ 9539dd2b-d2ec-46a3-aa9d-2a26e17b9038
begin
	using CairoMakie
	using DryTooling
...
# ╔═╡ 714a9833-29ca-47b2-aeac-12a24902f6a4
begin
	N = 2000
	L = 0.002
	T = 1173.15
    ...
    @time solve(model; t, τ, x, M = 30, α = 0.05, ε = 1.0e-08)
	...
	fig1 = let
	    ...
	    ax.xticks = 0.0:0.3:1.8
	    ax.yticks = 0.2:0.1:1.2
	    xlims!(ax, extrema(ax.xticks.val))
	    ylims!(ax, extrema(ax.yticks.val))
	    fig
	end
	
	fig2 = plotsimulationresiduals(model.res[]; showinner = true)[1]
end;

# ╔═╡ dd714e46-4c1e-4731-b37c-504c775a8dcc
fig1

# ╔═╡ c0522a2f-5ed5-4f31-aa08-a1ba0c238d02
fig2
...
DryTooling = "0dff88b2-42f1-4682-ada6-3beed8c0a17c"
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "340d6c450eff64c83fe9be146cc525f4f216ad90"
...
deps = ["ADTypes", "Adapt", "ArrayInterface", "BandedMatrices", "ConcreteStructs", "DiffEqBase", "ForwardDiff", "LinearAlgebra", "NonlinearSolve", "PreallocationTools", "RecursiveArrayTools", "Reexport", "SciMLBase", "Setfield", "SparseArrays", "SparseDiffTools", "TruncatedStacktraces", "UnPack"]
...
[[deps.DryTooling]]
deps = ["CSV", "CairoMakie", "CommonSolve", "DataFrames", "DifferentialEquations", "Distributions", "DocStringExtensions", "Documenter", "ExtendableGrids", "GLMakie", "Interpolations", "Ipopt", "JuMP", "LaTeXStrings", "Latexify", "Libdl", "LinearAlgebra", "Logging", "ModelingToolkit", "Plots", "Pluto", "PlutoUI", "Polynomials", "Printf", "Random", "Revise", "Roots", "Statistics", "StatsBase", "Symbolics", "Trapz", "Unitful", "YAML"]
git-tree-sha1 = "a429efcb21bbb4a0f17bd9ff0224ad50e55a6ff1"
uuid = "0dff88b2-42f1-4682-ada6-3beed8c0a17c"
version = "1.0.0"
...
git-tree-sha1 = "93d5d6241139aa13769861ee0f1ae564e0531652"
